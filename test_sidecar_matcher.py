...
class TestSidecarMatcher(unittest.TestCase):
    def test_exact_full_path_matching(self):
        """驗證 P1: photo.jpg ↔ photo.jpg.json 精準全檔名配對"""
    ...
    def test_cross_zip_exact_logical_path_matching(self):
        """驗證 P5: 跨 ZIP 媒體與 Sidecar 相同邏輯路徑配對"""
    ...
    def test_folder_and_zip_identical_matching_quality(self):
        ...
        zip_m = SourceItem("z_m", "TAKEOUT_ZIP", "Album/img.jpg", "img.jpg", ".jpg", 100, is_media=True, is_json=False)
        zip_j = SourceItem("z_j", "TAKEOUT_ZIP", "Album/img.jpg.json", "img.jpg.json", ".json", 50, is_media=False, is_json=True)
